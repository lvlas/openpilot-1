...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    ret.steeringTorque = cp.vl["EPS_2"]["COLUMN_TORQUE"]*4 #/4
    ret.steeringTorqueEps = cp.vl["EPS_2"]["EPS_TORQUE_MOTOR"]*4 #/4 #if Params().get_bool("ChryslerMangoLat") else cp.vl["EPS_2"]["TORQUE_MOTOR"]
    ret.steeringPressed = abs(ret.steeringTorque) > STEER_THRESHOLD*4 #/4
